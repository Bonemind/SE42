 ...
 * 
 */
@WebServiceClient(name = "RegistrationService", targetNamespace = "http://service.auction/", wsdlLocation = "http://localhost:8080/Registration?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REGISTRATIONSERVICE_QNAME = new QName("http://service.auction/", "RegistrationService");
    ...
    public Registration getRegistrationPort() {
        return super.getPort(new QName("http://service.auction/", "RegistrationPort"), Registration.class);
    }
    ...
    public Registration getRegistrationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.auction/", "RegistrationPort"), Registration.class, features);
    }
